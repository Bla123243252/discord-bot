-- ls_admin: Stubs für EasyAdmins Vorlese-Funktionen (verhindern nil-Fehler)
if ttsSpeechItem == nil then
    function ttsSpeechItem(item) return end
end
if ttsSpeechText == nil then
    function ttsSpeechText(text) return end
end
